...
$(function () {
    ...
    $(".nav-search-button").click(function () {
        ...
        Swal.fire({
            ...
            html: '<div class="srcpanel"><input tye="text" class="srctext" placeholder="ürün ara"/><a href="#" class="srcbutton" onclick="delm"><i class="fa fa-search"></i></a></div><div class="loading" style="display:none"><img src="/Images/load.gif"  style="max-width:70px;"></div><div class="listr row"></div>',
